...
<style>
  ...
  .team-line { padding: 0 16px 10px; font-size: 12px; color: #e8b800; font-weight: 600; }
  ...
  .metrics { display: grid; grid-template-columns: repeat(4, 1fr); gap: 6px;
             padding: 0 12px 10px; }
  .metric { background: #0d1525; border: 1px solid #253550; border-radius: 6px;
             padding: 8px 6px; text-align: center; }
  .metric-lbl { font-size: 9px; font-weight: 700; color: #4a5e80; letter-spacing: 0.08em; }
  .metric-val { font-size: 16px; font-weight: 700; line-height: 1.1; margin: 2px 0; }
  .metric-sub { font-size: 10px; color: #7888b0; }

  .note-section { padding: 0 12px 10px; }
  .sec-label { font-size: 9px; font-weight: 700; color: #4a5e80; letter-spacing: 0.1em;
               text-transform: uppercase; margin-bottom: 6px; }
  .sec-sub { font-weight: 400; color: #344a72; text-transform: none; letter-spacing: 0; }
  textarea { width: 100%; background: #0d1525; border: 1px solid #253550; border-radius: 6px;
             color: #dce8ff; padding: 7px 10px; font-family: inherit; font-size: 12px;
             resize: none; outline: none; }
  textarea:focus { border-color: #e8b800; }
